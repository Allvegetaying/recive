...
#define CRCREGINIT   0x0000
#define CRCXOROUT    0x0000
 ...
 * @return CRC16 校验结果
 */
static inline uint16_t CRC16(const uint8_t *message, int len)
{
    uint16_t reg_init = CRCREGINIT;
    uint16_t XorOUT = CRCXOROUT;
